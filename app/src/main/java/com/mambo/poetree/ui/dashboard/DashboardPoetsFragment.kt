...
import com.mambo.poetree.databinding.FragmentDashboardPoetsBinding
import com.mambo.poetree.ui.adapter.HaikuAdapter
import com.zhuinden.fragmentviewbindingdelegatekt.viewBinding

class DashboardPoetsFragment : Fragment(R.layout.fragment_dashboard_poets),
    HaikuAdapter.OnHaikuClickListener {

    private val binding by viewBinding(FragmentDashboardPoetsBinding::bind)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.poetsPoems.observe(viewLifecycleOwner) { poems ->
            binding.apply {
