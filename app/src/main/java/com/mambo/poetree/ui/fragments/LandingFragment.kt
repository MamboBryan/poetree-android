...
class LandingFragment : Fragment(R.layout.fragment_landing) {
    ...
    private fun navigateToOnBoarding() {
        ...
        findNavController().navigate(R.id.action_landingFragment_to_onBoardingFragment)
    }
    ...
    private fun navigateToAuthentication() {
        ...
        findNavController().navigate(R.id.action_landingFragment_to_authenticationFragment)
